...
#annot <- read.table('../merged_q10_annotated.bed')
#names(annot) <- c('Chr', 'Start', 'End', 'Peak.id', 'strand', 'score', 'sample', 'sample_count',  'gene_chr', 'gene_start', 'gene_end', 'gene.id', 'distance')
#names(annot)[7:11]<-c('KO1', 'KO2', 'GFP1', 'GFP2', 'GFP3')
```
